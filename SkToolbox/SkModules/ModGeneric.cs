...
//            base.CallerEntry = new SkMenuItem("Generic Menu\t►", () => Loaders.SkLoader.MenuController.RequestSubMenu(base.FlushMenu()), "Empty Menu with a long context tip");
